...
export class DungeonRenderer {
  ...
  updateVisibility() {
    ...
    newlyVisibleStructures.forEach(structure => {
      this.propRenderer.renderPropsInStructure(this.mapData, structure, this.tileSize);
      this.monsterRenderer.renderMonstersInStructure(this.mapData, structure, this.tileSize);
    });
